...
`--pretty=format:` switch.
    ...
    zstyle ':delorean:circuit:git:log:context' format ''
...
setting a style is as follows.
    ...
    zstyle ':delorean:circuit:git:info:context:subcontext' format 'string'
...
The following contexts must be enabled with the following zstyle:
    ...
    zstyle ':delorean:circuit:git:info' verbose 'yes'
...
and remote names, define the following styles.
    ...
    zstyle ':delorean:circuit:git:info:branch' format 'branch:%b'
    zstyle ':delorean:circuit:git:info:remote' format 'remote:%R'

Second, format how the above attributes are displayed in prompts.

    zstyle ':delorean:circuit:git:info:keys' format \
      'prompt'  ' git(%b)' \
      'rprompt' '[%R]'
