...
if ! zstyle -t ':warpdrive:engine:syntax-highlighting' color; then
  return 1
fi
...
# Set highlighters.
zstyle -a ':warpdrive:engine:syntax-highlighting' highlighters 'ZSH_HIGHLIGHT_HIGHLIGHTERS'
...
zstyle -a ':warpdrive:engine:syntax-highlighting' styles 'syntax_highlighting_styles'
