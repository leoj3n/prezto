...
`--pretty=format:` switch.
    ...
    zstyle ':warpdrive:engine:git:log:context' format ''
...
setting a style is as follows.
    ...
    zstyle ':warpdrive:engine:git:info:context:subcontext' format 'string'
...
The following contexts must be enabled with the following zstyle:
    ...
    zstyle ':warpdrive:engine:git:info' verbose 'yes'
...
and remote names, define the following styles.
    ...
    zstyle ':warpdrive:engine:git:info:branch' format 'branch:%b'
    zstyle ':warpdrive:engine:git:info:remote' format 'remote:%R'

Second, format how the above attributes are displayed in prompts.

    zstyle ':warpdrive:engine:git:info:keys' format \
      'prompt'  ' git(%b)' \
      'rprompt' '[%R]'
